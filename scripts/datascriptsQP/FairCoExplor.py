...
for positionBiasSeverity in positionBiasSeverities:
    ...
    for datasets,data_name_cur in data_rename.items():
        ...
        result_validated["FairCo with Marginal certianty"]=results_org.getGrandchildNode(result["fairness_strategy_FairCo"],"exploration_tradeoff_param_10")
        ...
        fig.savefig(os.path.join(OutputPath,positionBiasSeverity+data_name_cur+"FairCoExploration.pdf"), dpi=600, bbox_inches = 'tight', pad_inches = 0.05)
        plt.close(fig)