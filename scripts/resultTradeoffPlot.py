...
for positionBiasSeverity in positionBiasSeverities:
    ...
    for datasets,data_name_cur in data_rename.items():
        ...
        result_validated["QPfair"]=result["fairness_strategy_QPfair"]["n_futureSession_20"]
        ...
        fig.savefig(os.path.join(OutputPath,positionBiasSeverity+data_name_cur+"tradeoffplot.pdf"), dpi=600, bbox_inches = 'tight', pad_inches = 0.05)
        plt.close(fig)