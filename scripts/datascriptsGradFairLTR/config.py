...
desiredGradFair=["TopK","ExploreK","MMF","PLFair","FairCo","FairK(Ours)","MCFair(Ours)","ILP","LP",]
...
desiredGradFairMarker={}
desiredGradFairColorlist=["MCFair(Ours)","TopK","ExploreK","MMF","FairCo","FairK(Ours)","ILP","LP","PLFair"]
for method in desiredGradFairColorlist:
    desiredGradFairColor[method]=next(colors)
    desiredGradFairMarker[method]=next(marker)
