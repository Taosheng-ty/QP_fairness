...
for positionBiasSeverity in positionBiasSeverities:
    ...
    for metrics in metric_name:
        for datasets,data_name_cur in data_rename.items():
            ...
            result_validated["GradFair"]=result["fairness_strategy_GradFair"]["fairness_tradeoff_param_1000"]["exploration_tradeoff_param_10"]
            ...
            result_validated["LP"]=result["fairness_strategy_LP"]["n_futureSession_100"]["fairness_tradeoff_param_1000"]["exploration_tradeoff_param_0.0"]
