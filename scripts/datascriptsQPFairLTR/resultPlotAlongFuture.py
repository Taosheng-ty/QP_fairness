...
metric_name_dict={"test_NDCG_1_aver":"NDCG@1","test_NDCG_3_aver":"NDCG@3","test_NDCG_5_aver":"NDCG@5",\
    "test_NDCG_1_cumu":"cNDCG@1","test_NDCG_3_cumu":"cNDCG@3","test_NDCG_5_cumu":"cNDCG@5","test_disparity":"test_disparity"}
result_list=[]
...
for positionBiasSeverity in positionBiasSeverities:
    ...
    for datasets,data_name_cur in data_rename.items():
        ...
        result_validated["QPFair (Ours)"]=results_org.getGrandchildNode(result["fairness_strategy_QPFair"],"fairness_tradeoff_param_1.0")
        ...
        result_validated["QPFair (Ours)"]=results_org.getGrandchildNode(result_validated["QPFair (Ours)"],"exploration_tradeoff_param_0.0")
