...
for positionBiasSeverity in positionBiasSeverities:
    ...
    for datasets,data_name_cur in data_rename.items():
        ...
        result_validated["GradFair"]=result["fairness_strategy_GradFair"]
        ...
        result_validatedScatter["GradFair+w/oFair."]=result["fairness_strategy_Topk"]
        # result_validatedScatter["RandomK"]=result["fairness_strategy_Randomk"]
        result_validatedScatter["GradFair+w/o Eff."]=result["fairness_strategy_FairK"]
